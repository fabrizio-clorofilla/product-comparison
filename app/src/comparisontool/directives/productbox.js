    ...
    return {
      ...
      link: function ($scope, $element, $attrs) {
        ...
        $scope.setActiveTab = function(direction){
          ...
          switch(direction){
            case 'this':  $element.find(boxSelector).removeClass('hide').addClass('show');
                          $(btnTag).removeClass('inactive').addClass('active');
                          break;
            case 'next':  $element.next().find(boxSelector).removeClass('hide').addClass('show');
                          $(btnTag).next().removeClass('inactive').addClass('active');
                          break;
            case 'prev':  $element.prev().find(boxSelector).removeClass('hide').addClass('show');
